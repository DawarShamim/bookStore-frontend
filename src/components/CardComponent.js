...
function CardComponent({ item }) {
    return (
              <button 
              className="max-w-md mx-auto bg-white rounded-lg shadow-slate-500 overflow-hidden cursor-pointer hover:shadow-slate-100 transition duration-300 focus:outline-none"
